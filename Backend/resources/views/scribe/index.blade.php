...
<head>
    ...
    <script>
        var tryItOutBaseUrl = "https://teste-tecnico-fonte-ninja.onrender.com";
        var useCsrf = Boolean();
...
<body data-languages="[&quot;bash&quot;,&quot;javascript&quot;]">
    ...
    <div class="page-wrapper">
        ...
        <div class="content">
            ...
            <aside>
                <strong>Base URL</strong>: <code>https://teste-tecnico-fonte-ninja.onrender.com</code>
            </aside>
...
You can switch the language used with the tabs at the top right (or from the nav menu at the top left on mobile).&lt;/aside&gt;</code></pre>
    ...
    --get "https://teste-tecnico-fonte-ninja.onrender.com/api/v1/ping" \
    ...
    "https://teste-tecnico-fonte-ninja.onrender.com/api/v1/ping"
);
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <span id="example-requests-GETapi-v1-produtos">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "https://teste-tecnico-fonte-ninja.onrender.com/api/v1/produtos?search=%2Fproducts%3Fsearch%3Dnotebook" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "https://teste-tecnico-fonte-ninja.onrender.com/api/v1/produtos"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Server Error&quot;
            ...
            <span id="execution-results-GETapi-v1-produtos" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-v1-produtos"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-v1-produtos" data-method="GET" data-path="api/v1/produtos" data-authed="0"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-v1-produtos" onclick="tryItOut('GETapi-v1-produtos');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-v1-produtos" onclick="cancelTryOut('GETapi-v1-produtos');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-v1-produtos" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="GETapi-v1-produtos"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-v1-produtos"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    <i>optional</i> &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="search" data-endpoint="GETapi-v1-produtos"
                        value="/products?search=notebook" data-component="query">
                    <br>
                    <p>Opcional. Termo para busca por nome ou SKU do produto. Example:
                        <code>/products?search=notebook</code></p>
                </div>
            </form>
...
fetch(url, {
    ...
    body: JSON.stringify(body),
            ...
            <span id="execution-results-POSTapi-v1-produtos" hidden>
                <blockquote>Received response<span id="execution-response-status-POSTapi-v1-produtos"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-POSTapi-v1-produtos" data-method="POST" data-path="api/v1/produtos" data-authed="0"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-POSTapi-v1-produtos" onclick="tryItOut('POSTapi-v1-produtos');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-POSTapi-v1-produtos" onclick="cancelTryOut('POSTapi-v1-produtos');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-POSTapi-v1-produtos" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="POSTapi-v1-produtos"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="POSTapi-v1-produtos"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="nome" data-endpoint="POSTapi-v1-produtos" value=""
                        Notebook Dell"." data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="preco_venda"
                        data-endpoint="POSTapi-v1-produtos" value="250" data-component="body">
                    <br>
            ...
            <span id="example-requests-GETapi-v1-produtos--productId-">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "https://teste-tecnico-fonte-ninja.onrender.com/api/v1/produtos/12" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "https://teste-tecnico-fonte-ninja.onrender.com/api/v1/produtos/12"
);
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-v1-produtos--productId-" data-method="GET" data-path="api/v1/produtos/{productId}"
                ...
                <h3>
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-v1-produtos--productId-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="GETapi-v1-produtos--productId-" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    <input type="text" style="display: none" name="productId"
                        data-endpoint="GETapi-v1-produtos--productId-" value="12" data-component="url">
                    <br>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-PUTapi-v1-produtos--productId-" data-method="PUT" data-path="api/v1/produtos/{productId}"
                data-authed="0" data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-PUTapi-v1-produtos--productId-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="PUTapi-v1-produtos--productId-" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="productId"
                        data-endpoint="PUTapi-v1-produtos--productId-" value="12" data-component="url">
                    <br>
                    <p>ID do produto. Example: <code>12</code></p>
                </div>
                <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <i>optional</i> &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="nome" data-endpoint="PUTapi-v1-produtos--productId-"
                        value="" Notebook Dell Inspiron"." data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="preco_venda"
                        data-endpoint="PUTapi-v1-produtos--productId-" value="350" data-component="body">
                    <br>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-DELETEapi-v1-produtos--productId-" data-method="DELETE"
                data-path="api/v1/produtos/{productId}" data-authed="0" data-hasfiles="0" data-isarraybody="0"
                autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-DELETEapi-v1-produtos--productId-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="DELETEapi-v1-produtos--productId-" value="application/json"
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="productId"
                        data-endpoint="DELETEapi-v1-produtos--productId-" value="12" data-component="url">
                    <br>
                    <p>ID do produto. Example: <code>12</code></p>
                </div>
            </form>
            ...
            <span id="example-requests-GETapi-v1-compras">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "https://teste-tecnico-fonte-ninja.onrender.com/api/v1/compras?search=%2Fpurchases%3Fsearch%3D250" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "https://teste-tecnico-fonte-ninja.onrender.com/api/v1/compras"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Server Error&quot;
            ...
            <span id="execution-results-GETapi-v1-compras" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-v1-compras"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-v1-compras" data-method="GET" data-path="api/v1/compras" data-authed="0"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-v1-compras" onclick="tryItOut('GETapi-v1-compras');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-v1-compras" onclick="cancelTryOut('GETapi-v1-compras');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-v1-compras" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="GETapi-v1-compras"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-v1-compras"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    <i>optional</i> &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="search" data-endpoint="GETapi-v1-compras"
                        value="/purchases?search=250" data-component="query">
                    <br>
                    <p>Opcional. Termo de busca para ID ou valor total da compra. Example:
                        <code>/purchases?search=250</code></p>
                </div>
            </form>
...
fetch(url, {
    ...
    body: JSON.stringify(body),
            ...
            <span id="execution-results-POSTapi-v1-compras" hidden>
                <blockquote>Received response<span id="execution-response-status-POSTapi-v1-compras"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-POSTapi-v1-compras" data-method="POST" data-path="api/v1/compras" data-authed="0"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-POSTapi-v1-compras" onclick="tryItOut('POSTapi-v1-compras');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-POSTapi-v1-compras" onclick="cancelTryOut('POSTapi-v1-compras');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-POSTapi-v1-compras" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="POSTapi-v1-compras"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="POSTapi-v1-compras"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="fornecedor" data-endpoint="POSTapi-v1-compras"
                        value="" Fornecedor X"." data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    <details>
                        ...
                        <div style="margin-left: 14px; clear: unset;">
                            ...
                            &nbsp;
                            &nbsp;
                            <input type="number" style="display: none" step="any" name="produtos.0.id"
                                data-endpoint="POSTapi-v1-compras" value="5" data-component="body">
                            <br>
                        ...
                        <div style="margin-left: 14px; clear: unset;">
                            ...
                            &nbsp;
                            &nbsp;
                            <input type="number" style="display: none" step="any" name="produtos.0.quantidade"
                                data-endpoint="POSTapi-v1-compras" value="10" data-component="body">
                            <br>
                        ...
                        <div style="margin-left: 14px; clear: unset;">
                            ...
                            &nbsp;
                            &nbsp;
                            <input type="number" style="display: none" step="any" name="produtos.0.preco_unitario"
                                data-endpoint="POSTapi-v1-compras" value="25.5" data-component="body">
                            <br>
            ...
            <span id="example-requests-GETapi-v1-vendas">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "https://teste-tecnico-fonte-ninja.onrender.com/api/v1/vendas?search=%2Fsales%3Fsearch%3D500" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "https://teste-tecnico-fonte-ninja.onrender.com/api/v1/vendas"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Server Error&quot;
            ...
            <span id="execution-results-GETapi-v1-vendas" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-v1-vendas"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-v1-vendas" data-method="GET" data-path="api/v1/vendas" data-authed="0"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-v1-vendas" onclick="tryItOut('GETapi-v1-vendas');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-v1-vendas" onclick="cancelTryOut('GETapi-v1-vendas');" hidden>Cancel
                        🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-v1-vendas" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="GETapi-v1-vendas"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-v1-vendas"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    <i>optional</i> &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="search" data-endpoint="GETapi-v1-vendas"
                        value="/sales?search=500" data-component="query">
                    <br>
                    <p>Opcional. Termo de busca para ID ou valor total da venda. Example: <code>/sales?search=500</code>
                    </p>
                </div>
            </form>
...
fetch(url, {
    ...
    body: JSON.stringify(body),
            ...
            <span id="execution-results-POSTapi-v1-vendas" hidden>
                <blockquote>Received response<span id="execution-response-status-POSTapi-v1-vendas"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-POSTapi-v1-vendas" data-method="POST" data-path="api/v1/vendas" data-authed="0"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-POSTapi-v1-vendas" onclick="tryItOut('POSTapi-v1-vendas');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-POSTapi-v1-vendas" onclick="cancelTryOut('POSTapi-v1-vendas');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-POSTapi-v1-vendas" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="POSTapi-v1-vendas"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="POSTapi-v1-vendas"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="cliente" data-endpoint="POSTapi-v1-vendas" value=""
                        Fulano da Silva"." data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    <details>
                        ...
                        <div style="margin-left: 14px; clear: unset;">
                            ...
                            &nbsp;
                            <input type="number" style="display: none" step="any" name="produtos.0.id"
                                data-endpoint="POSTapi-v1-vendas" value="5" data-component="body">
                            <br>
                            <p>ID do produto. Example: <code>5</code></p>
                        </div>
                        <div style="margin-left: 14px; clear: unset;">
                            ...
                            &nbsp;
                            <input type="number" style="display: none" step="any" name="produtos.0.quantidade"
                                data-endpoint="POSTapi-v1-vendas" value="10" data-component="body">
                            <br>
                        ...
                        <div style="margin-left: 14px; clear: unset;">
                            ...
                            &nbsp;
                            <input type="number" style="display: none" step="any" name="produtos.0.preco_unitario"
                                data-endpoint="POSTapi-v1-vendas" value="50" data-component="body">
                            <br>
